...
WORKFLOWS = {
    ...
    ".github/workflows/crypto_dm.yml":         "agent_crypto_dm.py",
    ".github/workflows/stratege.yml":          "agent_stratege.py",
...
SECRETS_REQUIS = {
    ...
    "agent_crypto_dm.py":      {"ZOHO_EMAIL", "ZOHO_PASSWORD"},
    "agent_stratege.py":       {"ANTHROPIC_API_KEY", "ZOHO_EMAIL", "ZOHO_PASSWORD"},
