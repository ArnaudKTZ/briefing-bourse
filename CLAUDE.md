...
Ce workspace est le Lewis personnel d'Arnaud. Il a été créé avec le Jarvis Starter Kit pour servir d'assistant IA personnel au quotidien.
...
Je m'appelle Arnaud et je vis à Six-Fours-les-Plages (Var). Ingénieur en mécanique, je suis responsable de travaux chez Naval Group pour la maintenance des bateaux de la Marine Nationale. Je gère les dossiers de A à Z : recueil des besoins, rédaction des spécifications, consultation et négociation avec les sous-traitants, suivi des travaux, garant du budget, de la qualité et du planning.

Mes objectifs prioritaires actuels : décrocher une promotion en améliorant ma communication avec la hiérarchie, et lancer un projet personnel (bourse et/ou recherche de véhicules d'exception).

À long terme, tripler mes revenus sur 1 à 3 ans.
...
| `.claude/commands/` | Commandes personnalisées de mon Lewis |
| `.claude/skills/` | Skills (super-pouvoirs) de mon Lewis |
